...
protected:
	...
	// Beam Off
	std::string filename_beamoff_run4b = "/Volumes/T9/BNBSurpriseNTuples/beam_off/checkout_MCC9.10_Run4b_v10_04_07_09_Run4b_BNB_beam_off_surprise_reco2_hist.root";
	...
	// Beam Off
	//double pot_weight_beamoff_run4b = (double)294236984.0 / (double)88445969.0; // 88445969.0 Triggers
